...
import ru.zorb.storage.jooq.tables.daos.FieldViewDao;
...
public class ViewSettingFactory {
  ...
  public synchronized void init() {
    ...
    Iterable<ru.zorb.storage.jooq.tables.pojos.FieldView> fieldsViews = fieldViewDao.findAll();
   ...
   * @return
   */
  private ViewSetting convert(ru.zorb.storage.jooq.tables.pojos.FieldView fieldViewBean) {
  ...
  private ViewSetting createDefault(String metaClassCode, String fieldCode, String title, Integer number, FieldTypeView stringSingle) {
    ...
    if (fieldView2 == null) {
      ru.zorb.storage.jooq.tables.pojos.FieldView fieldView = new ru.zorb.storage.jooq.tables.pojos.FieldView();
