package ru.softshaper.web.rest.command;
...
import ru.softshaper.web.rest.command.bean.CommandBean;
import ru.softshaper.web.rest.command.bean.CommandStatusBean;
import ru.softshaper.web.rest.command.bean.ResultCommandBean;
