...
import ru.zorb.services.meta.bean.FileObjectBean;
...
public class FileObjectDataSourceImpl implements FileObjectDataSource {
  ...
  public static final ru.zorb.storage.jooq.tables.FileObject FILE_OBJECT_TABLE = ru.zorb.storage.jooq.tables.FileObject.FILE_OBJECT;
  ...
  public void deleteObject(String contentCode, String id) {
    ru.zorb.storage.jooq.tables.FileObject table = ru.zorb.storage.jooq.tables.FileObject.FILE_OBJECT;
