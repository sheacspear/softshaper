...
public class MetaStorageImpl implements MetaStorage {
  ...
  private Map<String, MetaClass> metaClassByTable = Maps.newHashMap();
	 ...
	 * (non-Javadoc)
	 *
	 * @see ru.softshaper.services.meta.MetaStorage#register(java.util.Collection)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see ru.softshaper.services.meta.MetaStorage#getMetaClass(java.lang.String)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see ru.softshaper.services.meta.MetaStorage#getMetaClassById(java.lang.Long)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see ru.softshaper.services.meta.MetaStorage#getAllMetaClasses()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see ru.softshaper.services.meta.MetaStorage#getMetaField(java.lang.Long)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see ru.softshaper.services.meta.MetaStorage#getMetaFields()
	 */
	@Override
  ...
  /* (non-Javadoc)
   * @see ru.softshaper.services.meta.MetaStorage#getMetaClassByTable(java.lang.String)
   */
  @Override
