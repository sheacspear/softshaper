...
import ru.softshaper.services.meta.bean.FieldBuilder;
import ru.softshaper.services.meta.bean.MetaBuilder;
...
public abstract class StaticContentBase implements StaticContent {
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.services.meta.StaticContent#getContentDataSource()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.services.meta.StaticContent#getMetaClass()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.services.meta.StaticContent#loadFields(java.util.Map)
   */
  @Override
