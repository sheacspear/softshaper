...
public class MetaFieldBean implements MetaField {
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.MetaField#getId()
   */
  @Override
  public String getId() {
    return id;
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.MetaField#getOwner()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.MetaField#getName()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.MetaField#getCode()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.MetaField#getColumn()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.MetaField#getType()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.MetaField#getLinkToMetaClass()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.MetaField#getBackReferenceField()
   */
  @Override
