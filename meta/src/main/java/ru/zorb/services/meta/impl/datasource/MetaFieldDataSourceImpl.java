...
import ru.zorb.services.meta.bean.MetaFieldBean;
import ru.zorb.services.meta.impl.GetObjectsParams;
import ru.zorb.services.meta.jooq.JooqFieldFactory;
import ru.zorb.services.meta.staticcontent.MetaFieldConditionChecker;
import ru.zorb.services.meta.staticcontent.meta.MetaFieldStaticContent;
import ru.zorb.storage.jooq.tables.FieldView;
import ru.zorb.storage.jooq.tables.daos.DynamicFieldDao;
import ru.zorb.storage.jooq.tables.records.DynamicFieldRecord;
...
public class MetaFieldDataSourceImpl implements ContentDataSource<MetaField> {
  ...
  public void updateObject(String contentCode, String id, Map<String, Object> values) {
    ...
    ru.zorb.storage.jooq.tables.DynamicField fieldTable = ru.zorb.storage.jooq.tables.DynamicField.DYNAMIC_FIELD;
  ...
  public void deleteObject(String contentCode, String id) {
    ru.zorb.storage.jooq.tables.pojos.DynamicField fieldsPojo = dynamicFieldDao.fetchOneById(Long.valueOf(id));
    ...
    if (orderFields != null) {
      stream = stream.sorted((o1, o2) -> {
        ...
        if (o1 == null) {
          ...
          compareResult = 0;
          //todo: something
          for (Map.Entry<MetaField, ru.zorb.services.meta.impl.SortOrder> order : orderFields.entrySet()) {
            ...
            if (compareResult != 0) {
              compareResult = ru.zorb.services.meta.impl.SortOrder.DESC.equals(order.getValue()) ? compareResult * -1 : compareResult;
              break;
            }
          }
        }
