package ru.softshaper.services.security;
...
import ru.softshaper.storage.jooq.tables.daos.DynamicContentSecurityDao;
import ru.softshaper.storage.jooq.tables.pojos.DynamicContentSecurity;
...
public class DynamicContentSecurityManager implements ContentSecurityManager {
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.security.dynamiccontent.ContentSecurityManager#canCreate(java.lang.Long)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.security.dynamiccontent.ContentSecurityManager#canRead(java.lang.Long)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.security.dynamiccontent.ContentSecurityManager#canUpdate(java.lang.Long)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.security.dynamiccontent.ContentSecurityManager#canDelete(java.lang.Long)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.security.dynamiccontent.ContentSecurityManager#getCurrentUserRoles()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.security.dynamiccontent.ContentSecurityManager#addRight(ru.softshaper.services.meta.MetaClass, java.lang.String, boolean, boolean, boolean, boolean)
   */
  @Override
  public void addRight(MetaClass metaClass, String role, boolean c, boolean r, boolean u, boolean d) {
    ru.softshaper.storage.jooq.tables.DynamicContentSecurity table = ru.softshaper.storage.jooq.tables.DynamicContentSecurity.DYNAMIC_CONTENT_SECURITY;
    if (!(c || r || u || d)) {
   ...
   * (non-Javadoc)
   *
   * @see ru.softshaper.security.dynamiccontent.ContentSecurityManager#deleteAllRight(ru.softshaper.services.meta.MetaClass)
   */
  @Override
