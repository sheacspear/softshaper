...
import ru.zorb.security.RestAuthenticationEntryPoint;
import ru.zorb.security.SHAPasswordEncoder;
import ru.zorb.security.token.RestTokenAuthenticationFilter;
import ru.zorb.security.token.TokenAuthenticationManager;
import ru.zorb.security.token.storage.DBTokenStorage;
import ru.zorb.security.token.storage.TokenStorage;
...
@ComponentScan("ru.zorb.security")
@EnableWebSecurity
