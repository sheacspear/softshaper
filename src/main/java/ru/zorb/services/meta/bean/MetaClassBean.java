...
public class MetaClassBean implements MetaClass {
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#getId()
   */
  @Override
  public String getId() {
    return id;
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#getCode()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#getName()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#getTable()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#getFields()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#getIdColumn()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#getIdSequence()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#getPrimaryKey()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#isCheckSecurity()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#isCheckObjectSecurity()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaClass#isFixed()
   */
  @Override
