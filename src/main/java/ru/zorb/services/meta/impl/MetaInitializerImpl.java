...
import ru.zorb.services.meta.MetaLoader;
...
public class MetaInitializerImpl implements MetaInitializer {
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaInitializer#registerLoader(ru.zorb.services.meta.MetaLoader)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaInitializer#init()
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.MetaInitializer#init(ru.zorb.services.meta.MetaClass)
   */
  @Override
