...
public class ObjectDataSourceImpl implements ContentDataSource<Record>, POJOContentDataSource {
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.meta.impl.datasource.Test#getObjects(org.jooq.impl.TableImpl, java.lang.Class, java.util.Collection)
   */
  @Override
  ...
  /*
     * (non-Javadoc)
     *
     * @see ru.zorb.services.dynamiccontent.ObjectDynamicContentDAO#createObject(java .util.Map)
     */
  @Transactional
  @Override
      ...
      if (value != null) {
        ...
        if (FieldType.LINK.equals(type)) {
          ...
          if (value instanceof Map) {
            realValue = fileDataSource.createObject(FileObjectStaticContent.META_CLASS, (Map<String, Object>) value);
          } else {
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.ObjectDynamicContentDAO#updateObject(java .lang.String, java.util.Map)
   */
  @Transactional
  @Override
   ...
   * (non-Javadoc)
   *
   * @see ru.zorb.services.dynamiccontent.ObjectDynamicContentDAO#deleteObject(java .lang.String)
   */
  @Transactional
  @Override
