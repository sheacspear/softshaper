package ru.softshaper.conf.workflow;
...
@ComponentScan({"ru.softshaper.services.workflow","ru.softshaper.datasource.workflow","ru.softshaper.staticcontent.workflow"})
